...
public class Remove_Staff extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter Staff Name OR Staff ID To Remove");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(60, 60, 60)
                        .addComponent(user_input, javax.swing.GroupLayout.PREFERRED_SIZE, 269, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(80, 80, 80)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(32, 32, 32)
                .addComponent(user_input, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        String input =user_input.getText();
         String query ="delete from staffs where staff_id='"+input+"' or name ='"+input+"';";
          ...
          try{
            ...
            if(rows>0)
            {
                JOptionPane.showMessageDialog(this, "Staff is removed from the Library");
            } else {
                   JOptionPane.showMessageDialog(this,"No such Staff exists");
            }
